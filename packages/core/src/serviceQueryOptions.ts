import { HttpClient, NetworkClientAvailable } from './networkClient';

export type QueryFnParams<TNetworkClient extends NetworkClientAvailable> = {
...
export type ServerStateQueryOptions<
  NetworkClient extends NetworkClientAvailable = HttpClient,
...
} & Omit<ServerStateQueryOptions<HttpClient, TQueryFnData, TError, TData, TQueryKey>, 'queryFn'>;
